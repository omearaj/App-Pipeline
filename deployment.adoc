...
The second job retrieves the artifacts from Artifactory, connects to Cloud Foundry and executes a script to deploy the artifacts. Below are the steps tp create these jobs.
