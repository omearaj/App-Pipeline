...
Set the build environment to use Generic-Artifactory integration. We'll use Artifactory as the true for our deployment artifacts

image:./images/PCF_Map_Artifactory_Store.png[Poll SCM]
